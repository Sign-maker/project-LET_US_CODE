import{S as n}from"./assets/local-storage-api-5465ab31.js";const m="shop-storage";new n(m);function f(t){return t.map(({category:c,img:r,is10PercentOff:u,name:a,price:o,size:d,_id:g})=>`<li class="cart-item" data-id="${g}">
