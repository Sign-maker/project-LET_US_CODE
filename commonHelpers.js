import{S as i,F as S}from"./assets/subscription-f5be2e94.js";import{S as m}from"./assets/vendor-bb007519.js";const C="shop-storage";new i(C);function h(e){return e.map(({category:o,img:r,name:c,price:t,size:l,_id:f})=>`<li class="cart-item" data-id="${f}">
