import{S as l}from"./assets/subscription-e3724da0.js";import"./assets/vendor-bb007519.js";const g="shop-storage";new l(g);function m(t){return t.map(({category:r,img:e,name:c,price:n,size:u,_id:p})=>`<li class="cart-item" data-id="${p}">
