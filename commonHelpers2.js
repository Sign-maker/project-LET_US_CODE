import{S as i}from"./assets/local-storage-api-c1a4955d.js";import{a as n}from"./assets/vendor-a61d8330.js";n.defaults.baseURL="https://food-boutique.b.goit.study/api";class h{constructor(){}async getProductCategories(){const{data:s}=await n("/products/categories");return s}async getProducts(s){const{data:e}=await n("/products",{params:{...s}});return e}async getProductDetails(s){const{data:e}=await n(`/products/${s}`);return e}async getPopularProducts(){const{data:s}=await n("/products/popular");return s}async getDiscountedProducts(){const{data:s}=await n("/products/discount");return s}async subscribeToNewsletter(s){return await n.post("/subscription",s,{headers:{"Content-Type":"application/json"}})}async placeOrder(s){const{data:e}=await n.post("/orders",s,{headers:{"Content-Type":"application/json"}});return e}}const m="/project-LET_US_CODE/assets/icons-43d8cdaf.svg";console.log(m);function E(t){return t.map(({category:s,img:e,is10PercentOff:o,name:c,popularity:a,price:r,size:l,_id:g})=>`<li class="products-card-item" data-id="${g}">
