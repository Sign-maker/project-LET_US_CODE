import"./assets/styles-f5b0a433.js";import{a as r}from"./assets/vendor-a61d8330.js";r.defaults.baseURL="https://food-boutique.b.goit.study/api";class p{constructor(){}async getProductCategories(){const{data:t}=await r("/products/categories");return t}async getProducts(t){const{data:e}=await r("/products",{params:{...t}});return e}async getProductDetails(t){const{data:e}=await r(`/products/${t}`);return e}async getPopularProducts(){const{data:t}=await r("/products/popular");return t}async getDiscountedProducts(){const{data:t}=await r("/products/discount");return t}async subscribeToNewsletter(t){return await r.post("/subscription",t,{headers:{"Content-Type":"application/json"}})}async placeOrder(t){const{data:e}=await r.post("/orders",t,{headers:{"Content-Type":"application/json"}});return e}}const n=new p;async function y(){try{const s=await n.getProductCategories();console.log("productCategories",s);const t={keyword:"apple",category:"Fresh_Produce",byABC:!0,byPrice:!0,byPopularity:!0,page:1,limit:6},e=await n.getProducts(t);console.log("products",e);const a="640c2dd963a319ea671e3676",o=await n.getProductDetails(a);console.log("productsDetails",o);const c=await n.getPopularProducts();console.log("popularProducts",c);const i=await n.getDiscountedProducts();console.log("discountedProducts",i);const d={email:"test@gmail.com",products:[{productId:"640c2dd963a319ea671e383b",amount:2}]},u=await n.placeOrder(d);console.log("placeOrder",u);const g={email:"test@gmail.com"},m=await n.subscribeToNewsletter(g);console.log("subscribeToNewsletter",m)}catch{}finally{}}y();const l=new p,f=document.querySelector(".popular-list"),h=document.querySelector(".discount-list");async function b(){try{const s=await l.getPopularProducts();f.innerHTML=v(s)}catch{}}b();async function P(){try{const s=await l.getDiscountedProducts();h.innerHTML=w(s)}catch{}}P();function v(s){return s.map(t=>{const{_id:e,name:a,img:o,category:c,size:i,popularity:d}=t;return`<li class="popular-item" id="${e}">
      ...
      </li>`}).join("")}function w(s){return s.slice(0,2).map(e=>{const{_id:a,name:o,img:c,price:i}=e;return`<li class="discount-item" id="${a}">
